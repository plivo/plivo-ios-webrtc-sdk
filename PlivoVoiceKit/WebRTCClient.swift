...
extension WebRTCClient{
    ...
    //Incomming Call
    func setRemote(offerSDP: String, onCreateAnswer: @escaping (String) -> Void){
        if self.peerConnection == nil{
        ...
        self.peerConnection?.setRemoteDescription(remoteSDP, completionHandler: { (err) in
            ...
            self.createAnswer(onCreateAnswer: onCreateAnswer)
        })
    }
...
extension WebRTCClient{
    ...
    func configureAudioSession() {
        ...
        do {
            try
                audioSession.setCategory(AVAudioSession.Category.playAndRecord.rawValue, with:[.defaultToSpeaker, .mixWithOthers, .duckOthers])
