...
class FeedbackManager{
    ...
    func sendStats(statsDict:inout [String:Any], type:String){
        ...
        if statsJson == "" {
            ...
            statsCounter += 1
            if ((type == Constant.CALL_STATS_MSG && (statsCounter == Constant.STATS_BUFFER_CAPACITY)) || (type  == Constant.CALL_ANSWERED_MSG) || (type  == Constant.CALL_SUMMARY_MSG) || (type  == Constant.TOGGLE_MUTE) || (type  == Constant.TOGGLE_HOLD) || (type  == Constant.CALL_RINGING_MSG) || (type  == Constant.AUDIO_DEVICE_TOGGLE)) {
    ...
    func sendQualityFeedbackStats(_ issueWithoutDuplicates: [AnyHashable]?, _ xcallUUID: String?, _ val: Int, _ notes: String?) {
        ...
        if xcallUUID != nil && StatsConfig.last_xcall_uuid != nil && xcallUUID == StatsConfig.last_xcall_uuid{
