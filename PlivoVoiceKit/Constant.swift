...
class Constant{
    ...
    static let SIP = "sip"
    static let SDK_NAME  = "PlivoIOSSDK"
    static let STATS_SOURCE = "iOSSDK"
    static let STATS_VERSION = "v1"
    static let PLIVO_ENDPOINT_VER = "2.1.17"
    ...
    static var registrationTimeout = 3600*24*60
    ...
    static let REG_TIMEOUT_ERROR = "Allowed values of regTimeout should be in between 120 and 86400 seconds only"
